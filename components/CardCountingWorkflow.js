...
const CardCountingWorkflow = ({ gameState, startGame, getOneMore, handleRevealAnswer, handleStartOver, answer }) => {
    ...
    switch (gameState) {
        ...
        case CardCountingStates.REVEAL_ANSWER:
            return <Button type={ButtonTypes.PRIMARY} clickEvent={handleStartOver} buttonText="Start Over!" label={"The answer is " + answer + "!"}></Button>
