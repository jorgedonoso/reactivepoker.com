...
export default () => (
  <Page title="Terms of Service">
    ...
    <h2>Warranty</h2>
    <p>WE ENDEAVOUR TO PROVIDE THE BEST SERVICE WE CAN, BUT YOU UNDERSTAND AND AGREE THAT THIS WEBSITES'S SERVICE IS PROVIDED “AS IS” AND “AS AVAILABLE”, WITHOUT EXPRESS OR IMPLIED WARRANTY OR CONDITION OF ANY KIND. USE THIS WEBSITE AT YOUR OWN RISK.</p>
    <h2>Changes</h2>
    <p>We reserve the right, at our sole discretion, to modify or replace these Terms at any time with no warning. If you do not agree to this policy, please stop using the Service.</p>
  </Page>
)
